...
public class GetListItemsQueryHandlerTests
{
    ...
    public GetListItemsQueryHandlerTests()
    {
        ...
        _handler = new GetListItemsQueryHandler(_itemRepository, _listRepository, _householdRepository, _currentUser);
    }

    [Fact]
    public async Task Handle_WithValidData_ReturnsItems()
    {
        // Arrange
